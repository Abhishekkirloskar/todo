...
First, clear stale handoff files from any previous run: delete the contents of .pipeline/ (spec.md, changes.md, test-results.md, review.md) if they exist. Create the .pipeline/ folder if it does not exist.
